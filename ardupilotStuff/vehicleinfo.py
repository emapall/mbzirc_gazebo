    ...
    "ArduCopter": {
        ...
        "frames": {
            ...
            "custom-hexa": {
                "make_target": "sitl",
                "waf_target": "bin/arducopter",
                "default_params_filename": ["default_params/custom-copter-hexa.parm" ],
            },
            "octa-quad": {
                "make_target": "sitl",
                "waf_target": "bin/arducopter",
            ...
            #progetto roccella
            "gazebo-MBZIRColo":{
                "waf_target": "bin/arducopter", #NON HO LA PIU PALLIDA IDEA di cosa questa linea faccia
                "default_params_filename":["default_params/copter.parm", # TODO: CAMBIARLA CON L'ESACOPTER
                                            "MBZIRC-provaParams/gazebo-MBZIRColo.parm"],
            },
            "gazebo-qualsiasicosa":{
                "waf_target": "bin/arducopter", #NON HO LA PIU PALLIDA IDEA di cosa questa linea faccia
                "default_params_filename":[###"default_params/copter-hexa.parm", # TODO: CAMBIARLA CON L'ESACOPTER
                                            "MBZIRC-provaParams/gazebo-MBZIRColo.parm"],
            },
            # HELICOPTER
            "heli": {
